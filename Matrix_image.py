...
#main class
class Matrix:
    def __init__(self, app, font_size=5):
        self.app = app
        self.FONT_SIZE = font_size
        self.SIZE = self.ROWS, self.COLS = app.HEIGHT // font_size, app.WIDTH // font_size
        self.katakana = np.array([random.randint(0, 1) for i in range(100)] + ['' for i in range(1)])
        ...
        self.image = self.get_image('bender.jpg')
...
class MatrixVision:
    def __init__(self):
        self.RES = self.WIDTH, self.HEIGHT = 450, 550
        pg.init()
